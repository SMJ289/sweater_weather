...
RSpec.describe DailyWeather do
  ...
  before(:each) do
    ...
    @hourly_weather = data[:hourly].map do |day|
  ...
  it '.initialize()' do
    ...
    expect(@hourly_weather.first.time).to eq("02:00:00 PM")
  end
  ...
  it '.format_time()' do
    expect(@hourly_weather.first.format_time(1591560000)).to eq("02:00:00 PM")
  end
end